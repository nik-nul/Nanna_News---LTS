...
\end{tabular}
\subsection{软件新技术讲坛：多模态大模型高效微调与安全} % 讲座 describer: Ando
时间：2025年5月7日（星期三） 10:30
\\腾讯会议ID：593-138-754
\\详见：\url{https://mp.weixin.qq.com/s/N9uvemAfVktZaIMO4ONxQg}
\subsection{高研院仙林学术午餐会} % 校级活动 describer: Cirlpso
...
\subsection{化学化工系列讲座预告} % 讲座 describer: Ando
报告人：王瑞兵 （教授，澳门大学）
\\
\\【主题】讨论会
...
\subsection{柏林戏剧节2024年剧目分享和对谈} % 校级活动 describer: Ando
...
\subsection{2026巴黎高科国际工程师项目宣讲会} % 讲座 describer: Ando
活动时间：5月15日北京时间晚上7点
...
\subsection{学术专栏 | 本科生论坛（教师系列第102讲）} % 讲座 describer: blob
题目: 从泰勒展开谈起
\\报告人：陈柯
...
\subsection{预告 | 物理学院学术报告会(第59期)} % 讲座 describer: nik_nul
...
\subsection{“减脂不停步，健康加速度”} % 讲座 describer: Ando
...
\subsection{王垚：“东愁”与怀旧的政治学——漫谈后冷战东欧电影} % 讲座 describer: Ando
...
\section{共话发展：图书馆读者座谈会} % 校级活动 describer: Ando
...
\section{期末考试时间发布} % 校级活动 describer: nik_nul
本学期期末考试时间系统已发布，可以登录“网上办事服务大厅ehall.nju.edu.cn”搜索"我的课表"进行查看。
\section{魔法奇游｜“魔法奇游夜”哈利波特主题音乐节奇幻降临！} % 校级活动 describer: Jolly
...
\section{2025年南京大学“小蓝鲸劳动月”系列主题基础劳动实践活动安排} % 校级活动 describer: Cirlpso
...
\section{【通知】关于再次开放在校学生体检预约的通知} % 校级活动 describer: Cirlpso
...
\section{关于《毛概》《习概》 实践教学的要求与说明} % 校级活动 describer: Cirlpso
...
\section{简历优化指导} % 校级活动 describer: Ando
...
\section{南京大学首届数智应用大赛——关于“数智倍乘”冠军赛报名及选题的通知} % 校级活动 describer: Cirlpso
...
\section{“走出宿舍鼓励师”社群打卡计划} % 校级活动 describer: Ando
...
\hline
    ...
    \hline
\end{tabular}
\subsection{第二届七院联合草地音乐节 2025毕业声宴} % 院级活动 describer: instruconrevo
活动主题：“乐奏青春音，悦动毕业季”
...
\subsection{四院联合草地音乐节} % 院级活动 describer: Ando
...
\subsection{物理学院第二届趣味运动会等你来玩！} % 院级活动 describer: Hikari
活动对象：物理学院全体师生
...
\subsection{物道研行｜物理学院首届“棋理杯”棋类比赛——围棋赛道} % 院级活动 describer: Hikari
...
\subsection{法科生职业发展校友沙龙} % 院级活动 describer: nik_nul
...
\subsection{INSCHOOL校园随舞歌单} % 社团活动 describer: nik_nul
详见：\url{https://mp.weixin.qq.com/s/WIxlFiQNAh728G4JTatStg}
\subsection{AED主题校园定向打卡竞赛} % 社团活动 describer: instruconrevo
...
\subsection{ 「娱神纪·九歌」门票放送\&展台领奖} % 社团活动 describer: HOllyWood
展台信息：
...
\subsection{ 第十三届粤语歌唱大赛决赛} % 社团活动 describer: Ando
...
\subsection{南心支教团实践志愿招募} % 社团活动 describer: HOllyWood
